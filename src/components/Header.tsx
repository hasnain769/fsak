        ...
        <header className="sticky top-0 z-50 w-full bg-[#0e0e16]/95 backdrop-blur-md border-b border-white/8 shadow-lg">
            <div className="container mx-auto px-4 h-20 flex items-center justify-between">
                ...
                <div className="hidden md:flex items-center gap-6">
                    <Link href={pathname} locale={toggleLocale} className="font-bold text-sm tracking-wider uppercase hover:text-color-accent transition-colors text-white/70 hover:text-white">
            ...
            {/* Mobile Nav */}
            {isMenuOpen && (
                <div className="md:hidden bg-color-background border-b border-color-dark-grey/10 absolute top-20 left-0 w-full flex flex-col px-6 py-6 space-y-4 font-medium shadow-xl">
